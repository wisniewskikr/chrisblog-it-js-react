...
Usage steps:
1. (Optional) In a command line create react application with `npx create-react-app js-react-gui-html-helloworld-component-functional-props`
...
##### Goal
The goal of this project is to present how to use **props** in **Functional Component** in an application type **GUI HTML** based on **JavaScript** programming language with usage **react** framework. This application consists of **single** HTTP page and displays **Hello World** message.

##### Terminology
Terminology explanation:
* **Functional Component**: in React it's a component defined as a JS function. It's stateless.
* **Props**: they are used to send information from Parent to Children.
