...
Usage steps:
1. (Optional) In a command line create react application with `npx create-react-app js-react-gui-html-helloworld-component-higher-order`
...
1. In a http browser (e.g. Chrome) visit `http://localhost:3000`
   * Expected **Hello World** page with message in a console **Hello World from Logger**
...
##### Goal
The goal of this project is to present how to use **Higher-Order Component** in an application type **GUI HTML** based on **JavaScript** programming language with usage **react** framework.

##### Terminology
Terminology explanation:
* **Higher-Order Component**: A Higher-Order Component is a component which takes another component as an argument and adds extra features to another component.
