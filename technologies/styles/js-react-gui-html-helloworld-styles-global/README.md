...
Usage steps:
1. (Optional) In a command line create react application with `npx create-react-app js-react-gui-html-helloworld-styles-global`
...
##### Goal
The goal of this project is to present how to use **style** type **public** in an application type **GUI HTML** based on **JavaScript** programming language with usage **react** framework.

##### Terminology
Terminology explanation:
* **Style**: Cascading Style Sheets (CSS) is used to format the layout of a webpage.
* **Public**: Public CSS is the technique to define the single element in public folder. This element is available in all components.
