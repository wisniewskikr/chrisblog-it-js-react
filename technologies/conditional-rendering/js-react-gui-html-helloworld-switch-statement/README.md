...
Usage steps:
1. (Optional) In a command line create react application with `npx create-react-app js-react-gui-html-helloworld-switch-statement`
...
##### Goal
The goal of this project is to present how use **conditional rendering** type **switch statement** in an application type **GUI HTML** based on **JavaScript** programming language with usage **react** framework. This application consists of **single** HTTP page and displays **Hello World** message.
...
* **Switch Statement**: this statement switches beteween many conditions. If condition in one of the statements fits then such block of code is performed.
